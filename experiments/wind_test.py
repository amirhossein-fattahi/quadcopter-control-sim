...
def simulate_wind_experiment():
    ...
    trajectory = HoverTrajectory(position=np.array([0.0, 0.0, 1.5]), yaw=0.0)
...
def main():
    ...
    result = simulate_wind_experiment()
    ...
    logs_logger = SimpleLogger(base_dir="results/logs", run_name="wind_test")
    figs_logger = SimpleLogger(base_dir="results/figures", run_name="wind_test")

    logs_logger.save_metadata({
        "experiment": "wind_test",
    ...
    figs_logger.save_figures(rendered["figures"], prefix="wind")
